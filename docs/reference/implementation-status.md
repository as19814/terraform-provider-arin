...
| Organizations | Individual data source and arin_org_poc; all five non-admin association roles pass mock and OT&E lifecycles | Full-record client with mocked CRUD/tickets and OT&E no-change PUT; Terraform lifecycle, live creation/deletion, Admin replacement and ticket reconciliation remain; see [organization evidence](organizations.md) and [association evidence](org-pocs.md) |
