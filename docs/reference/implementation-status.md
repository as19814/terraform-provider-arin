...
| Hosted ROAs | Individual/list data sources, arin_roa and shared transaction client; Terraform create/import/update/destroy, AS0 and IRR link/unlink/relink pass OT&E; non-default maximum lengths and both deletion modes pass client tests; uncertain-write recovery passes mocks and Terraform | Shared IRR ownership, AS0 auto-link behavior and final endpoint audit; see [evidence](rpki.md) |
