...
| Whois-RWS | Six individual record data sources with typed fields and complete XML; all six pass native Terraform reads and clean plans on OT&E and production | Relationship lists, searches, IP/CIDR queries and final field/endpoint audit; see [Whois-RWS evidence](whois-rws.md) |
