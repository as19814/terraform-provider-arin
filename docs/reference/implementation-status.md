...
| Whois-RWS | Six individual record and twelve relationship data sources with typed fields and complete XML; native Terraform reads and clean plans pass on both origins | Searches, IP/CIDR queries and final field/endpoint audit; see [Whois-RWS evidence](whois-rws.md) |
