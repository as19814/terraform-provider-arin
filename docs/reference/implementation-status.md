...
| Whois-RWS | Six individual record, twelve relationship, and five search data sources with typed fields and complete XML; native Terraform reads and clean plans pass on both origins | IP/CIDR queries, remaining query options and final field/endpoint audit; see [Whois-RWS evidence](whois-rws.md) |
