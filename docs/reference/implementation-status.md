...
| Hosted ROAs | Individual/list data sources and shared transaction client; combined IPv4/IPv6 creation, atomic replacement, AS0, non-default maximum lengths and both IRR auto-link deletion modes pass OT&E | Terraform resource/import, pre-existing/shared IRR ownership and AS0 auto-link behavior; see [evidence](rpki.md) |
