...
| Public RDAP | Org network discovery, ASN record/inventory, POC references, full public entity lookup, and address/prefix network lookup; IPv4/IPv6 Terraform reads pass OT&E and production without credentials | Domain lookups and remaining search/reverse-search variants; standalone nameserver lookup returns native 501; see [RDAP audit](rdap.md) |
