...
.PHONY: testote
testote:
	ARIN_OTE_WRITE_TESTS=1 TF_ACC=1 go test -p 1 ./internal/arin ./internal/provider -run '^TestOTE(ASSet|IRRRoute|RouteSet|Autnum|Customer|CustomerNetGraph|Net|NetMultiBlock|NetMetadata|NetAssignmentClient|DelegationClient|Delegation|DelegationNameserver|POC|POCClient|POCContacts|OrgPOC|OrgPOCClient|RPKIClient|RPSLClient|RPSLRead|RPSLResource|ASPA|ROA|ReportClient|ReportResource|TicketStatusClient|TicketStatus)Lifecycle$$|^TestOTEOrganizationClientNoChange$$|^TestOTEOrgResourceRecovery$$' -v -count=1 -timeout 10m
