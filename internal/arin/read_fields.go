...
var routeFields = joinFields(irrCommon, []Field{required(text("prefix", "prefix")), required(text("origin_as", "originAS")), text("net_handle", "netHandle"), text("auto_linked_roa_handle", "autoLinkedRoaHandle"), stringsField("member_of", "memberOf/routeSetRef/@name")})
