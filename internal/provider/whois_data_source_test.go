...
func TestAccWhoisLookups(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.arin_whois_delegation.test", "ds_records.0.algorithm_name", "ECDSAP256SHA256"), resource.TestCheckResourceAttr("data.arin_whois_delegation.test", "ds_records.0.digest_type_name", "SHA-256"), resource.TestCheckResourceAttr("data.arin_whois_org.test", "street_address.0", "First"), resource.TestCheckResourceAttr("data.arin_whois_net.test", "ip_version", "v4"), resource.TestCheckResourceAttr("data.arin_whois_net.test", "net_blocks.0.cidr_length", "24"), resource.TestCheckResourceAttr("data.arin_whois_poc.test", "phones.0.type", "O"), resource.TestCheckResourceAttr("data.arin_whois_asn.test", "start_asn", "64496"), resource.TestCheckResourceAttr("data.arin_whois_delegation.test", "ds_records.0.key_tag", "12345"))
