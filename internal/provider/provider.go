...
func (p *ARINProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	sources := []func() datasource.DataSource{NewNetworksDataSource, NewRPSLDataSource, NewRPKISetupDataSource, NewRPKISetupRequestDataSource, NewRPKIPublicationDataSource, NewBulkWhoisDataSource, NewInvalidPOCsDataSource}
